...
<body>
  <div id="portafoglioCliente">
    ...
    <input type="number" id="importo_euro" name="importo_euro" value="0" step="1" oninput="calculate()">
    <br><br>
    <label for="importo_tcoin">Importo in Tcoin: </label>
    <span id="output"></span>
    <br><br>
    <button type="submit" style="background-color: #6a64f1;" onclick="handleRicarica()">Ricarica portafoglio</button>
    <br><br>
    <button type="submit" style="background-color: #6a64f1;" onclick="handleStorico()">Storico ricariche</button>
  </div>
