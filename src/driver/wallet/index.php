...
<div id="portafoglioCliente">
  ...
  <input type="number" id="importo_tcoin" value="0" step="3" oninput="calculate()">
  <br><br>
  <label for="importo_euro">Importo in Euro: </label>
  <span id="output"></span>
  <br><br>
  <button type="submit" style="background-color: #6a64f1;" onclick="handleBonifico();">
    Inserisci Bonifico</button>



  <br><br>
  <button type="submit" style="background-color: #6a64f1;" onclick="handleStorico();">Storico bonifici</button>
 </div>
